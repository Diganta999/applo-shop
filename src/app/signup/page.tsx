    ...
    <div className="min-h-screen">
      ...
      <main className="pt-32 pb-20 px-6">
        <div className="max-w-md mx-auto glass-bright rounded-3xl p-10">
          ...
          <p className="text-black/60 text-sm mb-8">Join Vitreous for a faster checkout.</p>
          ...
          <p className="text-sm text-black/60 mt-6 text-center">
            ...
            <Link href="/login" className="font-extrabold text-black underline underline-offset-4">
              Sign in
            </Link>
          </p>
        </div>
